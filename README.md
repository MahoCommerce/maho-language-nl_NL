# Dutch (nl_NL) language pack for Maho ecommerce platform

This repository contains the nl_NL language pack for the Maho e-commerce platform.
It provides localization support for the nl_NL language and region.
...
```bash
composer require mahocommerce/maho-language-nl_nl
```
